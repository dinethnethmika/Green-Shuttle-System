...
* **Backend:** PHP (Native)
* **Database:** MySQL (InfinityFree / XAMPP)
* **Libraries:** PHPMailer (for SMTP Email functionality)

## 📸 Screenshots
<img width="1891" height="871" alt="image" src="https://github.com/user-attachments/assets/158e2c9e-c1fa-49af-979f-623c0ce3dee9" />
<img width="1888" height="862" alt="image" src="https://github.com/user-attachments/assets/a28899a5-4c7e-418d-864c-c8f12e793ef3" />
<img width="624" height="1280" alt="image" src="https://github.com/user-attachments/assets/2af9575e-a1d4-48ed-aaee-18128e86a813" />
<img width="616" height="1280" alt="image" src="https://github.com/user-attachments/assets/621ea5d4-9769-4f5f-ae98-b37ee1398c26" />
...
4.  Update `student_home.php` and `booking_history.php` with your SMTP Gmail credentials.
5.  Run on a local server (XAMPP) or host online.
